...
fn main() {
    ...
    println!("   Zero address equals SqlAddress::ZERO: {}", ZERO_ADDRESS == SqlAddress::ZERO);
    ...
    mod protocol_config {
        ...
        pub const GOVERNANCE: SqlAddress = sqladdress!("0x1234567890123456789012345678901234567890");
        pub const EMERGENCY_PAUSE: SqlAddress = sqladdress!("0xabcdefabcdefabcdefabcdefabcdefabcdefabcd");
    ...
    println!("   Total system contracts: {}", protocol_config::SYSTEM_CONTRACTS.len());
