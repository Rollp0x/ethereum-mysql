...
fn test_u256_hash_consistency() {
    ...
    println!("   Zero hashes equal: {}", calculate_hash(&alloy_zero) == calculate_hash(&sql_zero));
    println!();
}
...
fn test_mixed_collections() {
    ...
    println!("   Contains converted: {}", address_map.contains_key(&back_to_sql));
    println!();
    ...
    println!("   Set size after inserting 3 values (2 unique): {}", value_set.len());
    println!("   Contains val1: {}", value_set.contains(&val1));
    println!("   Contains val2 (same as val1): {}", value_set.contains(&val2));
...
fn test_performance_comparison() {
    ...
    println!("   Performance ratio (sql/alloy): {:.2}", 
